...
Route::domain('{tenant}.' . config('app.domain'))->middleware('tenant')->group(function () {
    //Tenant Auth Routes
    Route::get('/', [WebsiteController::class, 'index'])->name('tenant.home');
    Route::get('/{slug}', [WebsiteController::class, 'index'])->name('tenant.page');
...
Route::domain(config('app.domain'))->prefix('admin')->middleware(['auth', 'role:admin'])->as('admin.')->group(function () {
    ...
    Route::domain('{tenant}.' . config('app.domain'))->middleware('tenant')->group(function () {
        ...
        Route::get('/customizes', [CustomizesController::class, 'index'])->name('admin-customizes');
        Route::post('/update/customizes', [CustomizesController::class, 'store'])->name('admin-update-customizes');
        Route::get('/images', [ImagesController::class, 'index'])->name('admin-images');
        Route::post('/upload/image', [ImagesController::class, 'store'])->name('admin-upload-image');
        Route::delete('/delete/image/{id}', [ImagesController::class, 'destroy'])->name('admin-delete-image');
