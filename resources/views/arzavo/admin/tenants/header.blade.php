...
<div class="bg-primary border-rounded border-primary overflow-hidden mb-4">
    <div class="flex justify-between items-center py-3 px-4">
        <div>
            <h2 class="text-lg font-bold text-primary mb-1 flex items-center gap-1"><i class="fa-solid fa-building-columns mr-1 text-base"></i>
                Tenant Management
            </h2>
            <p class="text-sm text-secondary hidden sm:block">Manage all tenants across Arzavo platform</p>
        </div>
        ...
        <div class="right-content flex gap-2 items-center">
            ...
            <button
                ...
                onclick="document.getElementById('courseAddPopup').classList.remove('hidden')">
                Add New
