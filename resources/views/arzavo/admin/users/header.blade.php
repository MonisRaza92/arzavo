...
<div class="bg-primary border-rounded border-primary overflow-hidden mb-4">
    <div class="flex justify-between items-center py-3 px-4">
        <div>
            <h2 class="text-lg font-bold text-primary mb-1 flex items-center gap-1"><i class="fa-solid fa-users mr-1 text-base"></i>
                Users Management
            </h2>
            <p class="text-sm text-secondary hidden sm:block">Manage all users across Arzavo platform</p>
        </div>
