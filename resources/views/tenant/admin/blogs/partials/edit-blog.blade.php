<div id="blogEditPopup{{ $blog->id }}" class="hidden fixed inset-0 z-100 bg-black/90 flex items-center justify-center pt-10">
    ...
    <div class="popup-content bg-primary border-primary border-rounded w-full max-w-md h-full sm:h-auto md:max-h-10/12 overflow-auto scrollbar">
        ...
        <form action="{{ route('admin.blog.update', ['blog' => $blog->slug]) }}" method="POST">
            ...
            <div class="p-4">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="meta_description"
                        ...
                        class="w-full p-2 bg-primary border-primary border-rounded input-focus text-sm">{{ $blog->meta_description }}</textarea>
                </div>
            ...
            <div class="flex justify-end gap-2 border-top p-4 sticky bottom-0 bg-primary">
                ...
                <button type="button"
                    onclick="document.getElementById('blogEditPopup{{ $blog->id }}').classList.add('hidden')"
