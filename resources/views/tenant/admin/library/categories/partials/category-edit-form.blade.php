...
<script>
    function functionGetBookCategoryDetails(categoryId) {

        fetch(`/admin/book-categories/${categoryId}/get`)
            .then(response => response.json())
            .then(data => {
                // Populate the form fields with the fetched data
                document.getElementById('categoryEditForm').action = `/admin/book-categories/${data.id}/update`;
            ...
            .catch(error => {
                console.error('Error fetching book category details:', error);
            });
    }
</script>
