            ...
            <div class="bg-primary border-primary border-rounded p-5">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="meta_keywords" value="{{ old('meta_keywords') }}" placeholder="e.g. math book, study notes, pdf download"
                            class="w-full p-2 bg-primary border-primary border-rounded input-focus text-sm text-primary">
                    </div>

                    {{-- Meta Description --}}
                    <div>
                        <x-input.textarea name="meta_description" label="Meta Description" :value="old('meta_description')" rows="3" placeholder="Brief search engine meta snippet..." />
                    </div>
                </div>
            </div>
