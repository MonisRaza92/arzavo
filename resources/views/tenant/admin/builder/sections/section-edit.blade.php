            ...
            <div class="w-full">
                ...
                <div class="richtext-wrapper bg-primary border-primary border-rounded overflow-hidden">
                    ...
                    <div class="flex gap-1 p-1 border-bottom">
                        <button type="button" data-action="bold" class="border-rounded bg-secondary font-bold text-center flex-1">B</button>
                        <button type="button" data-action="italic" class="border-rounded bg-secondary font-semibold text-center flex-1 italic">I</button>
                        <button type="button" data-action="underline" class="border-rounded bg-secondary font-semibold text-center flex-1 underline">U</button>
                        <button type="button" data-action="link" class="border-rounded bg-secondary font-semibold text-center flex-1">🔗</button>
                        <button type="button" class="border-rounded bg-secondary font-semibold text-center flex-1 overflow-hidden">
