...
<div class="my-4 space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
            <h2 class="text-2xl font-bold tracking-tight text-primary">Student Academic & LMS Progress Reports</h2>
            <p class="text-xs text-secondary mt-1">Real-time academic portfolio, batch course enrollments, attendance reliability, and learning activity.</p>
        </div>
    </div>
