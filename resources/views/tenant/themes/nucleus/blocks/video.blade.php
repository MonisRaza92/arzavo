@php
$videoType = $block->settings['video_type'] ?? 'youtube';
$youtubeUrl = $block->settings['youtube_url'] ?? '';
$vimeoUrl = $block->settings['vimeo_url'] ?? '';
$videoFile = $block->settings['video_file'] ?? '';
$videoPoster = $block->settings['video_poster'] ?? '';
$aspectRatio = $block->settings['aspect_ratio'] ?? '16:9';
$videoWidth = $block->settings['video_width'] ?? 'full';
$customWidth = $block->settings['custom_width'] ?? 80;
$alignment = $block->settings['alignment'] ?? 'center';
$mobileAlignment = $block->settings['mobile_alignment'] ?? 'center';
$autoplay = $block->settings['autoplay'] ?? 'no';
$muted = $block->settings['muted'] ?? 'yes';
$controls = $block->settings['controls'] ?? 'yes';
$borderRadius = $block->settings['border_radius'] ?? 8;
