@php
$targetDate = $block->settings['target_date'] ?? '';
$countdownTitle = $block->settings['countdown_title'] ?? 'Coming Soon';
$showTitle = $block->settings['show_title'] ?? 'yes';
$titlePosition = $block->settings['title_position'] ?? 'top';
$displayFormat = $block->settings['display_format'] ?? 'days_hours_minutes_seconds';
$layoutStyle = $block->settings['layout_style'] ?? 'boxes';
...
$showLabels = $block->settings['show_labels'] ?? 'yes';
$separatorStyle = $block->settings['separator_style'] ?? 'colon';
$animation = $block->settings['animation'] ?? 'flip';
$expiredMessage = $block->settings['expired_message'] ?? 'Event has started!';
