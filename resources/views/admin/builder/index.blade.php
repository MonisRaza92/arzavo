...
@section('content')
@include('admin.customizes.includes.navbar')
@include('admin.customizes.includes.sidebar')
<div class="p-4 ml-[300px] mt-16" id="previeweSection">
    <div class="builder-container relative">
        <div class="w-full relative border-rounded overflow-auto h-dvh scrollbar" style="{{ $customizes['primary-color'] ?? '#f5f5f5' }}">
            @include('admin.customizes.includes.preview')
        </div>
    </div>
</div>
<x-image-upload />
